...
public class Song implements Comparable {
    ...
    /**
     * Nested static comparator class for comparing songs by artist. This
     * compares two Song objects based on their artist fields, ignoring case.
     */
    ...
    public static void main(String[] args) {
        ...
        // Testing CmpTitle comparator
        System.out.println("\nTesting CmpTitle comparator:");
        CmpTitle cmpTitle = new CmpTitle();
        System.out.println("Song1 vs Song2 (by title) = " + cmpTitle.compare(s1, s2)); // Expected based on title comparison
        System.out.println("Song2 vs Song1 (by title) = " + cmpTitle.compare(s2, s1)); // Expected based on title comparison
        System.out.println("Song1 vs Song3 (by title) = " + cmpTitle.compare(s1, s3)); // Expected based on title comparison
    }
}
